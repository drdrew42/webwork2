  ...
  _createClass(LeaderTable, [{
    ...
    value: function componentDidMount() {
      ...
      $.post(leaderboardURL, requestObject, function (data) {
        ...
        var globalData = data.filter(function (item, i, arr) {
        ...
        globalData.forEach(function (item) {
          maxScore = parseInt(item.numOfProblems) * parseInt(pointsPerProblem) + parseInt(item.achievementPtsSum);
        ...
        var localData = globalData.filter(function (item, i, arr) {
          return item.ours;
        });
    ...
    value: function checkOption(option) {
      ...
      var newDataLocal = newDataGlobal.filter(function (item, i, arr) {
        return item.ours;
      });
